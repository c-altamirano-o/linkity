      ...
      <table className="w-full">
        <thead>
          <tr className="bg-slate-50 border-b border-slate-200">
            <th className="text-left text-[12.5px] font-medium text-slate-500 px-4 py-2.5">Módulo</th>
            <th className="text-left text-[12.5px] font-medium text-slate-500 px-4 py-2.5">Adopción</th>
            <th className="text-left text-[12.5px] font-medium text-slate-500 px-4 py-2.5"></th>
          </tr>
        </thead>
        <tbody>
          {modulos.map((m) => {
                ...
                >
                  <td className="px-4 py-2.5">
                    <p className="text-[13.5px] font-medium text-slate-800">
                      {m.name}
                      {m.isCore && <span className="text-[11.5px] text-slate-400 font-normal"> · núcleo (todos lo tienen)</span>}
                    </p>
                  </td>
                  <td className="px-4 py-2.5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[12.5px] text-slate-500">{m.activosCount}/{m.totalTenants}</span>
                    </div>
                  </td>
