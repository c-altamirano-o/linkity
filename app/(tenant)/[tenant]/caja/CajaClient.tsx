        ...
        >
          <div className="flex items-center justify-between px-4 py-3 border-b border-border">
            ...
            {sesionActual ? (
              ...
              <div className="flex items-center gap-1.5 text-[10px] font-medium px-2 py-1 rounded-full bg-red-50 text-red-600">
          ...
          {sesionActual ? (
            <>
              <div className="mx-3 my-3 bg-primary rounded-xl p-4">
                <p className="text-[10px] text-primary-foreground/60 mb-1">Efectivo actual en caja</p>
                ...
                <div className="grid grid-cols-3 gap-2 mt-3 pt-3 border-t border-primary-foreground/15">
                  {[
                    ...
                    <div key={i.label}>
                      <p className="text-[9px] text-primary-foreground/50 mb-0.5">{i.label}</p>
                      <p className="text-[11px] font-medium text-primary-foreground">{i.value}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="flex-1 overflow-y-auto px-4 py-2">
                <p className="text-[10px] font-semibold text-muted-foreground tracking-widest mb-2">RESUMEN DE LA SESIÓN</p>
            ...
            {[
              ...
              <div key={m.label} className="bg-muted rounded-lg p-2.5 sm:p-3">
                <div className="flex items-center justify-between mb-1">
                  <p className="text-[9px] sm:text-[10px] text-muted-foreground">{m.label}</p>
                  <m.icon className={`w-3 h-3 sm:w-3.5 sm:h-3.5 ${m.color}`} />
                </div>
                <p className={`text-sm sm:text-base font-semibold ${m.color}`}>{m.value}</p>
                <p className="text-[9px] sm:text-[10px] text-muted-foreground mt-0.5 truncate">{m.sub}</p>
              </div>
            ))}
          </div>
              ...
              <thead className="sticky top-0 bg-card border-b border-border z-10">
                <tr>
                  {[
                    ...
                    <th
                      key={h.label}
                      className={`text-left text-[10px] font-medium text-muted-foreground px-3 sm:px-4 py-2.5 whitespace-nowrap ${
                        h.right ? "text-right" : ""
                ...
                {movsFiltrados.map((mov) => (
                  <tr key={mov.id} className="border-b border-border/60 hover:bg-muted transition-colors">
                    <td className="px-3 sm:px-4 py-2.5">
                      <p className="text-[10px] font-semibold text-primary">{mov.folio}</p>
                    ...
                    <td className="px-3 sm:px-4 py-2.5 hidden sm:table-cell">
                      <span className={`text-[9px] font-medium px-2 py-0.5 rounded-full ${metodoBadge[mov.metodo] || "bg-muted text-muted-foreground"}`}>
                        {mov.metodo}
                      </span>
                    </td>
                    <td className="px-3 sm:px-4 py-2.5 hidden sm:table-cell">
                      <span className={`text-[9px] font-medium px-2 py-0.5 rounded-full ${tipoBadge[mov.tipo]}`}>{tipoLabel[mov.tipo]}</span>
                    </td>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center z-50">
          <div className="bg-card rounded-t-2xl sm:rounded-2xl p-5 w-full sm:w-80 shadow-xl">
            ...
            <div className="space-y-3 mb-4">
              <div>
                <label className="block text-[11px] font-medium text-muted-foreground mb-1">Concepto</label>
                <input
                  type="text"
                  value={concepto}
              ...
              <div>
                <label className="block text-[11px] font-medium text-muted-foreground mb-1">Monto</label>
                <input
                  type="number"
                  value={monto}
      ...
      {mostrarAbrirModal && (
        <div className="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center z-50">
          <div className="bg-card rounded-t-2xl sm:rounded-2xl p-5 w-full sm:w-80 shadow-xl">
            ...
            <div className="space-y-3 mb-4">
              <div>
                <label className="block text-[11px] font-medium text-muted-foreground mb-1">Monto de apertura</label>
                <input
                  type="number"
                  value={montoApertura}
      ...
      {mostrarCerrarModal && sesionActual && (
        <div className="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center z-50">
          <div className="bg-card rounded-t-2xl sm:rounded-2xl p-5 w-full sm:w-80 shadow-xl">
            ...
            <div className="space-y-3 mb-4">
              <div>
                <label className="block text-[11px] font-medium text-muted-foreground mb-1">Efectivo contado</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-[11px] font-medium text-muted-foreground mb-1">Notas (opcional)</label>
                <input
                  type="text"
                  value={notasCierre}
