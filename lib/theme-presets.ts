...
export function construirPresetWindowsPhone(
  ...
  const neutrales = esOscuro
    ? {
        "--background": hsl(h, 0.16, 0.09),
        "--foreground": hsl(h, 0.08, 0.96),
        "--card": hsl(h, 0.14, 0.14),
        "--card-foreground": hsl(h, 0.08, 0.96),
        "--popover": hsl(h, 0.14, 0.14),
        "--popover-foreground": hsl(h, 0.08, 0.96),
        "--secondary": hsl(h, 0.12, 0.2),
        "--secondary-foreground": hsl(h, 0.08, 0.96),
        "--muted": hsl(h, 0.12, 0.2),
        "--muted-foreground": hsl(h, 0.06, 0.65),
        "--accent": hsl(h, 0.18, 0.24),
        "--accent-foreground": hsl(h, 0.08, 0.96),
        "--border": hsl(h, 0.12, 0.26),
        "--input": hsl(h, 0.12, 0.28),
        "--sidebar": hsl(h, 0.18, 0.06),
        "--sidebar-foreground": hsl(h, 0.08, 0.96),
        "--sidebar-accent": hsl(h, 0.18, 0.16),
        "--sidebar-accent-foreground": hsl(h, 0.08, 0.96),
        "--sidebar-border": hsl(h, 0.12, 0.2),
        "--sidebar-ring": hsl(h, 0.08, 0.55),
      }
    : {
        "--background": hsl(h, 0.22, 0.98),
        "--foreground": hsl(h, 0.1, 0.1),
        "--card": "hsl(0, 0%, 100%)",
        "--card-foreground": hsl(h, 0.1, 0.1),
        "--popover": "hsl(0, 0%, 100%)",
        "--popover-foreground": hsl(h, 0.1, 0.1),
        "--secondary": hsl(h, 0.14, 0.95),
        "--secondary-foreground": hsl(h, 0.1, 0.15),
        "--muted": hsl(h, 0.14, 0.95),
        "--muted-foreground": hsl(h, 0.06, 0.42),
        "--accent": hsl(h, 0.24, 0.92),
        "--accent-foreground": hsl(h, 0.1, 0.15),
        "--border": hsl(h, 0.14, 0.9),
        "--input": hsl(h, 0.14, 0.9),
        "--sidebar": "hsl(0, 0%, 100%)",
        "--sidebar-foreground": hsl(h, 0.1, 0.1),
        "--sidebar-accent": hsl(h, 0.24, 0.92),
        "--sidebar-accent-foreground": hsl(h, 0.1, 0.15),
        "--sidebar-border": hsl(h, 0.14, 0.9),
